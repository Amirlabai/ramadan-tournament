...
- **Match comments (Jul 2026):** Flat tokenized [`CommentSection`](client/src/components/CommentSection.tsx) under match expand (boys); count, skeleton, submit success, fetch retry, `Anonymous` → אנונימי. Not mounted on `/world-cup/*`.
