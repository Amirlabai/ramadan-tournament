...
import { uploadAvatar, deleteAvatar, useGoogleAvatar, updatePlayerProfile, leaveTeam, cancelPlayerMapping } from '../controllers/userController';
...
router.post('/avatar/use-google', authenticate, useGoogleAvatar);
