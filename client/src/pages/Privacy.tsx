...
const Privacy = () => (
  ...
  >
    ...
    <ul>
      ...
      <li>נתוני שימוש פסאודונימיים באתר (רק לאחר אישור עוגיות אנליטיקה) — מזהה סשן אנונימי בדפדפן, נתיבי עמודים ואירועי שימוש בסיסיים הנשמרים בשרת שלנו; אין קישור לחשבון המשתמש</li>
    ...
    <p>
      ...
      (Vercel Analytics ורישום אירועי שימוש בשרת) מופעלות רק לאחר לחיצה על &quot;מאשר/ת הכל&quot; בבאנר העוגיות.
